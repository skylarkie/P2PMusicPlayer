...
def thread_send_data(so_lst,data,chunk_num):
    #print("1111")
    data_array = bytearray()
    #chunk_num = 0
    #print(chunk_num)
...
class Music_player:
    ...
    def set_request_flag(self,flag):
    ...
    def play_music(self):
        ...
        while self.running:
            ...
            if data:
                ...
                chunk_num = int((current_seconds * float(self.info['SampleRate']))*(self.info['NumChannels']*self.info['BitsPerSample']/8) /1024)
                #print(chunk_num)
                if len(self.so_lst)!=0:
                    #print("fuck")
                    thr1 = threading.Thread(target=thread_send_data,args=(self.so_lst,data,chunk_num,))
